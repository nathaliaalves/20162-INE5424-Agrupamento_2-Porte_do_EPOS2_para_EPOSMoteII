...
class Cortex_M_I2C : private Cortex_M_Model, private I2C_Common {
public:
    Cortex_M_I2C(Role r = I2C_Common::MASTER, char port_sda = 'B', unsigned int pin_sda = 1, char port_scl = 'B', unsigned int pin_scl = 0)
